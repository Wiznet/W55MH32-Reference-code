...
int main(void)
{
    ...
    printf("ADC temperature sensor and VREFINT passageway, Channel_16、Channel_17\n");
...
void DMA1_Channel1_IRQHandler(void)
{
    if (DMA_GetITStatus(DMA1_IT_TC1) != RESET)
    {
        ...
        printf("temperature sensor AD value = %d , voltage value = %2.4f , VREFINT = %d , voltage value = %2.4f\n", DAM_ADC_Value[0],
