...
void DES_Func_Test()
{
    ...
    r_printf((0 == memcmp(au8DESCipher_ECB, au8Result, DES_TEST_LEN)), "wiz_des_ecb test\n");
    ...
    callDes.u32Crc    = WIZCRC_CalcBuff(0xffff, &callDes, sizeof(WIZ_SYM_CRYPT_CALL) - 4);
    WIZDES_EncDec(&callDes);
    r_printf((0 == memcmp(au8Plain, au8Result, DES_TEST_LEN)), "wiz_des_cbc test\n");
}
...
void TDES_Func_Test()
{
    ...
    r_printf((0 == memcmp(au8TDESCipher_ECB, au8Result, DES_TEST_LEN)), "wiz_tdes_ecb test\n");
    ...
    callTdes.u16Opt    = WIZ_DES_OPT_BLK_CBC | WIZ_DES_OPT_MODE_DECRYPT | WIZ_TDES_OPT_KEY_3;
    callTdes.pu8Key    = au8Key;
    callTdes.u32Crc    = WIZCRC_CalcBuff(0xffff, &callTdes, sizeof(WIZ_SYM_CRYPT_CALL) - 4);
    WIZTDES_EncDec(&callTdes);
    r_printf((0 == memcmp(au8Plain, au8Result, DES_TEST_LEN)), "wiz_tdes_cbc test\n");
}
