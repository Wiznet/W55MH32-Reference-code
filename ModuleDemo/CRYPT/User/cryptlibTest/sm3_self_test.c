...
void test_SM3(void)
{
    ...
    uint8_t Hash[32];
    uint8_t Len;
    uint8_t wizash0[] = {0x66, 0xC7, 0xF0, 0xF4, 0x62, 0xEE, 0xED, 0xD9, 0xD1, 0xF2, 0xD4, 0x6B, 0xDC, 0x10, 0xE4, 0xE2,
                        0x41, 0x67, 0xC4, 0x87, 0x5C, 0xF2, 0xF7, 0xA2, 0x29, 0x7D, 0xA0, 0x2B, 0x8F, 0x4B, 0xA8, 0xE0}; 
    uint8_t wizash1[] = {0xde, 0xbe, 0x9f, 0xf9, 0x22, 0x75, 0xb8, 0xa1, 0x38, 0x60, 0x48, 0x89, 0xc1, 0x8e, 0x5a, 0x4d,
    ...
    WIZSM3_Cal(Hash, Message0, Len);
    sprintf(s, "SM3 wiz_sm3 Test %d\n", Len * 8);
    t = (!memcmp(Hash, wizash0, sizeof(wizash0)));
    r_printf(t, s);

    Len = sizeof(Message1) - 1;
    wiz_sm3(Hash, Message1, Len);
    sprintf(s, "SM3 wiz_sm3 Test %d\n", Len * 8);
    t = (!memcmp(Hash, wizash1, sizeof(wizash1)));
    r_printf(t, s);
    ...
    len = sizeof(Message0) - 1;                    
    WIZSM3_Starts(&ctx);
    WIZSM3_Update(&ctx, pu8In, len);
    WIZSM3_Finish(&ctx, Hash);
    sprintf(s, "SM3 wiz_sm3 Test %d\n", Len * 8);
    t = (!memcmp(Hash, wizash0, sizeof(wizash1)));
    r_printf(t, s);
    ...
    len = sizeof(Message1) - 1;                    
    WIZSM3_Starts(&ctx);
    WIZSM3_Update(&ctx, pu8In, 8);
    WIZSM3_Update(&ctx, pu8In + 8, len - 8);
    WIZSM3_Finish(&ctx, Hash);
    
    sprintf(s, "SM3 WIZSM3_Finish Test %d\n", Len * 8);
    t = (!memcmp(Hash, wizash1, sizeof(wizash1)));
    r_printf(t, s);
...
//void wiz_SM3_update_len(uint8_t *pu8Buff, uint32_t u32Size, uint8_t pu8HashRes[32])
//{
...
//        for(i = 0; i < u32P; i++)
//        {
//            WIZSM3_Update(&ctx, pu8In + i * au8M[j], au8M[j]);
//        }
//        WIZSM3_Update(&ctx, pu8In + i * au8M[j], u32R);
//
//        WIZSM3_Finish(&ctx, au8Hash);
...
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 300);
//    sprintf(s, "SM3 wiz_sm3 Test %d\n", 300 * 8);
//    t = (!memcmp(Hash, au8Hash_300Bytes, sizeof(Hash)));
//    r_printf(t, s);

//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 54);
//    sprintf(s, "SM3 wiz_sm3 Test %d\n", 54 * 8);
//    t = (!memcmp(Hash, au8Hash_54Bytes, sizeof(Hash)));
//    r_printf(t, s);
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 55);
//    sprintf(s, "SM3 wiz_sm3 Test %d\n", 55 * 8);
//    t = (!memcmp(Hash, au8Hash_55Bytes, sizeof(Hash)));
//    r_printf(t, s);
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 56);
//    sprintf(s, "SM3 wiz_sm3 Test %d\n", 56 * 8);
//    t = (!memcmp(Hash, au8Hash_56Bytes, sizeof(Hash)));
//    r_printf(t, s);
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 57);
...
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 64);
...
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 64*4+54);
//    sprintf(s, "SM3 wiz_sm3 Test %d\n", (64*4+54) * 8);
//    t = (!memcmp(Hash, au8Hash_64_4_54Bytes, sizeof(Hash)));
//    r_printf(t, s);
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 64*4+55);
//    sprintf(s, "SM3 wiz_sm3 Test %d\n", (64*4+55) * 8);
//    t = (!memcmp(Hash, au8Hash_64_4_55Bytes, sizeof(Hash)));
//    r_printf(t, s);
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 64*4+56);
//    sprintf(s, "SM3 wiz_sm3 Test %d\n", (64*4+56) * 8);
//    t = (!memcmp(Hash, au8Hash_64_4_56Bytes, sizeof(Hash)));
//    r_printf(t, s);
//
//    memset(Hash, 0, sizeof(Hash));
//    WIZSM3_Cal(Hash, (uint8_t *)au8Message0, 64*4+57);
...
//
//
//    wiz_SM3_update_len((uint8_t *)au8Message0, 54, au8Hash_54Bytes);
//    wiz_SM3_update_len((uint8_t *)au8Message0, 55, au8Hash_55Bytes);
//    wiz_SM3_update_len((uint8_t *)au8Message0, 56, au8Hash_56Bytes);
//    wiz_SM3_update_len((uint8_t *)au8Message0, 57, au8Hash_57Bytes);
//
//    wiz_SM3_update_len((uint8_t *)au8Message0, 64*4+54, au8Hash_64_4_54Bytes);
//    wiz_SM3_update_len((uint8_t *)au8Message0, 64*4+55, au8Hash_64_4_55Bytes);
//    wiz_SM3_update_len((uint8_t *)au8Message0, 64*4+56, au8Hash_64_4_56Bytes);
//    wiz_SM3_update_len((uint8_t *)au8Message0, 64*4+57, au8Hash_64_4_57Bytes);
//
//}
